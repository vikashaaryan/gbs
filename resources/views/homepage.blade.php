    ...
    <main class=" px-4">
        ...
        <section class="max-w-7xl mx-auto mb-16">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <!-- Category Card 1 -->
                <a href="{{ route('user') }}" class="category-card bg-white rounded-xl shadow-md p-6 text-center cursor-pointer hover:shadow-lg transition-shadow duration-300 hover:-translate-y-1 transform transition-transform">
